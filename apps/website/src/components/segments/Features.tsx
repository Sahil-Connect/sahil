          ...
          <div className="mb-10 lg:w-6/12">
            <h1 className="text-center font-bold mb-4 text-2xl md:text-3xl lg:text-5xl lg:text-left">
              ...
              <span className="block">
                <span className="yellow-line">core features</span>
              </span>
            </h1>
            <p className="text-center text-gray-600 max-w-[50ch] lg:text-left">
              These features make Sahil the perfect platform for your business.
              Each feature is designed with your business needs in mind.
            </p>
          </div>
            ...
            <ol className="relative border-s border-gray-200">
              <li className="mb-10 ms-6 lg:ms-10">
                ...
                <p className="text-base font-normal text-gray-600">
                  A seamless registration process. This feature ensures a smooth
                  onboarding experience for all users by providing necessary
                  details that help tailor the platform’s services to their
                  specific needs.
                </p>
              </li>
              <li className="mb-10 ms-6 lg:ms-10">
                ...
                <p className="text-base font-normal text-gray-600">
                  At the heart of Sahil is a sophisticated matching process.
                  This feature connects businesses with the right suppliers and
                  customers based on various factors such as product type,
                  location, quantity, and price.
                </p>
              </li>
              <li className="ms-6 lg:ms-10">
                ...
                <p className="text-base font-normal text-gray-600">
                  Sahil is all about efficiency and reliability. We ensure goods
                  are distributed from suppliers to businesses, and from
                  businesses to customers in a timely manner. Users can monitor
                  the progress of their deliveries from start to finish.
                </p>
              </li>
            </ol>
          </div>
